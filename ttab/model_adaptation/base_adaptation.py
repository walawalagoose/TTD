...
class BaseAdaptation(object):
    ...
    def get_src_data(self, scenario, data_size, data_augment=False):
        return self._auxiliary_data_cls.construct_src_dataset(
            scenario, data_size, data_augment=data_augment
        )
    ...
    def compute_fishers(self, scenario, data_size):
        ...
        self.fisher_dataset, self.fisher_loader = self.get_src_data(scenario, data_size, True)
