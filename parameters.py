...
def get_args():
    ...
    parser.add_argument(
        "--ckpt_path",
        default="./pretrained_ckpts/cifar10/resnet26_bn_ssh_cifar10.pth",
        type=str,
    )
    ...
    # # reset layer fraction for selective reset in some adaptation methods (e.g., codire)
    # parser.add_argument(
    #     "--reset_layer_frac",
    #     default=0.2,
    #     type=float,
    #     help="Fraction of adaptible layers to selectively reset when a domain switch is detected (0.0-1.0).",
    # )

    # define the task & model & adaptation & selection method.
    parser.add_argument("--model_name", default="resnet26", type=str)
    parser.add_argument("--group_norm", default=None, type=int) # group_norm_num_groups
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="ViT-L/14",
        type=str,
        help="CLIP VLM backbone (e.g., RN50, ViT-B/16, ViT-L/14).",
    )
    parser.add_argument(
    ...
    parser.add_argument("--cross_domain_batch_shuffle", default=False, type=str2bool, help="CDC setting in CTTA.")
    parser.add_argument(
        "--cdc_mode",
        default="random",
        choices=["random", "dirichlet"],
        type=str,
    )
    parser.add_argument("--cdc_slot_num", default=3, type=int)
    parser.add_argument("--cdc_delta", default=1.0, type=float)
    ...
    #     "--aug_size",
    #     default=32,
    #     help="number of per-image augmentation operations in memo, ttt, and tpt",
    #     type=int,
    # )
    parser.add_argument(
